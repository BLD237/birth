...
<body style="background-color:#4e78ea" >
  <div class="container">
    <div class="row">
    <form id="data-collection-form" action="/birth/action.php" method="post">
      ...
      <input  class="form-control input-sm" type="text" name="applicantidnumber" id="child-age" required>
            ...
            <hr>
    <div class="col">       
      <h2 style="text-align: center;" >Child's Information</h2>
      <div class="form-group pb-4"> 
      ...
      <!-- next info -->
      <div class="col">       
      <h2 style="text-align: center;" >Father's Information</h2>
      <div class="form-group pb-4"> 
      ...
      <!-- next info -->
      <div class="col">       
      <h2 style="text-align: center;" >Mother's Information</h2>
      <div class="form-group pb-4"> 
      ...
      <hr>
      <div class="col">       
      <h2 style="text-align: center;" >Witness Information/Midwife</h2>
      <div class="form-group pb-4"> 
      <label for="child-age">Nationality*</label>
